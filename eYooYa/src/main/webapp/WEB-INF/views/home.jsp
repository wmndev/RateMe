...
<body ng-app="app" >
					...
					<form class="navbar-form">
						...
						<div class="form-group">
							<angucomplete id="members"
								...
								ng-model="searchStr1" minlength=2 selectedobject="nick" dataBind="location"
								url="api/i/v1/serach/ac?token=" datafield="results" updateParent="updateParentModel()"
						...
						<div class="form-group">
							<angucomplete id="locations" placeholder="Location" pause="100"
								...
								titlefield="name,nickName" descriptionfield="description"
								imagefield="pic"
								inputclass="form-control control-right input-md" />
				...
				<div class="col-sm-4">
					<div class="row">
						<div class="col-sm-10 col-sm-offset-2 text-center">
							<h3>Robust</h3>
							<p>There is other content and snippets of details or features
								that can be placed here..</p>
				...
				<div class="col-sm-4 text-center">
					<div class="row">
						<div class="col-sm-10 col-sm-offset-1 text-center">
							<h3>Simple</h3>
							<p>You may also want to create content that compells users to
								scroll down more..</p>
				...
				<div class="col-sm-4 text-center">
					<div class="row">
						<div class="col-sm-10 text-center">
							<h3>Clean</h3>
							<p>In the first 30 seconds of a user's visit to your site
								they decide if they're going to stay..</p>
	...
	<section class="container-fluid" id="section2">
		<div class="row">
			<div class="col-sm-8 col-sm-offset-2 text-center">
				...
				<br>
				<p class="lead">Bootstrap is a free collection of tools for
					...
					JavaScript extensions. It is the No.1 project on GitHub with
					65,000+ stars and 23,800 forks (as of March 2014) [1] and has been
					used by NASA and MSNBC, among many others..</p>
				<br> <i style="font-size: 120px" class="fa fa-camera fa-5x"></i>
	...
	<section class="container-fluid" id="section3">
		...
		<div class="row">
			<div class="col-sm-6 col-sm-offset-3">
				<h3 class="text-center">Vertical scrolling has become a popular
					and lasting trend in Web design.</h3>
				<div class="row">
					<div class="col-xs-4 col-xs-offset-1">Some brand-tacular
						designs even have home page content that is taller that 12,000
						pixels. That's a lotta content.</div>
					<div class="col-xs-2"></div>
					<div class="col-xs-4 text-right">Anyhoo, this is just some
						random blurb of text, and Bootply.com is a playground and code
						editor for Bootstrap.</div>
				</div>
				<p class="text-center">
					<img src="/assets/example/img_mtnpeople.png"
		...
		<div class="row">
			<div class="col-sm-8 col-sm-offset-2">
				<img src="/assets/example/bg_smartphones.jpg"
					class="img-responsive center-block ">
				<p class="text-center">Images will scale down proportionately as
					browser width narrows.</p>
			</div>
		</div>
	</section>
					...
					<div class="col-sm-4 col-xs-12">
						<div class="list-group">
							<a href="#" class="list-group-item active">
								...
								<p class="list-group-item-text">Option 2 - this is more
									about this</p>
							</a> <a href="#" class="list-group-item">
								...
								<button class="btn btn-primary btn-lg btn-block">Get
									Started</button>
							</a>
						</div>
					</div>
					...
					<div class="col-sm-4 col-xs-12">
						<div class="list-group text-center">
							<a href="#" class="list-group-item active">
								...
								<button class="btn btn-default btn-lg btn-block">$10
									per month</button>
							</a>
						</div>
					</div>
					...
					<div class="col-sm-4 col-xs-12">
						<div class="list-group text-right">
							<a href="#" class="list-group-item active">
								...
								<button class="btn btn-default btn-lg btn-block">$20
									per month</button>
							</a>
						</div>
					</div>
	...
	<section class="container-fluid" id="section6">
		...
		<img src="/assets/example/bg_iphone.png"
			class="img-responsive center-block ">
