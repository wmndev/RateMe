...
public class MongoUsersConnectionRepository implements
    ...
    private final ConnectionFactoryLocator socialAuthenticationServiceLocator;
    ...
    public MongoUsersConnectionRepository(UserSocialConnectionRepository userSocialConnectionRepository, 
    		ConnectionFactoryLocator socialAuthenticationServiceLocator, TextEncryptor textEncryptor){
