...
public enum PlaceLookupHttpURLs {
	...
	TEXT_QUERY("https://maps.googleapis.com/maps/api/place/textsearch/json?query={query}&location={lat},{lng}&radius={radius}&key={apiKey}"),
	GEOCODING("https://maps.googleapis.com/maps/api/geocode/json?address={address}&key={apiKey}");
